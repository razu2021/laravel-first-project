...
<div class="row">
  <div class="col-xl-12">
      <form method="post" action="{{url('dashboard/website/blogbanner/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              ...
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/blogbanner')}}"><i class="fa fa-th"></i>All service  information </a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                ...
                <input type="text" class="form-control form_control" id="" name="heading" value="{{$data->slider_title}}">
              </div>
            </div>
           {{-- end  --}}
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="caption" value="{{$data->slider_heading}}">
              </div>
            </div>
           {{-- end  --}}
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="title" value="{{$data->slider_caption}}">
              </div>
            </div>
           {{-- end  --}}
            {{-- end  --}}
