  ...
  <div class="col-xl-12">
      <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>View history  Information</div>
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/companyhistory')}}"><i class="fa fa-th"></i>All history  info</a>
              </div>
            </div>
          </div>
          <div class="card-body">
