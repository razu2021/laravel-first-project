    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header bg-secondary">
              <div class="row">
                <div class="col-md-8 card_header_title text-white"><i class="fa fa-gg-circle"></i>company founded history  Information</div>
                <div class="col-md-4 text-end card_header_btn">
                  <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/companyhistory/add')}}"><i class="fa fa-plus-circle"></i>Add history info</a>
                </div>
              </div>
            </div>
            <div class="card-body">
                      ...
                      <div class="btn-group" role="group">
                        <div class="btn-group" role="group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('dashboard/website/companyhistory/view/'.$data->slug)}}">View</a></li>
                            <li><a class="dropdown-item" href="{{url('dashboard/website/companyhistory/edit/'.$data->slug)}}">Edit</a></li>
...
<div id="softdelete-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
  <div class="modal-dialog">
      <form method="post" action="{{url('dashboard/website/companyhistory/softdelete')}}">
        @csrf
