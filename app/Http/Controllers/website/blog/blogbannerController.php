...
namespace App\Http\Controllers\website\ourteam;
...
class blogbannerController extends Controller
{
    ...
    public function index(){
       ...
       return view('admin.website.blogbanner.all' ,compact('all'));
    }

    public function add(){
        return view('admin.website.blogbanner.add');
    }
    public function edit($slug){
        $data=blogbanner::where('slider_status',1)->where('slider_slug',$slug,)->firstOrFail();
        return view('admin.website.blogbanner.edit',compact('data'));
    }
    public function view($slug){
        $data=blogbanner::where('slider_status',1)->where('slider_slug',$slug,)->firstOrFail();
        return view('admin.website.blogbanner.view',compact('data'));
    }
