...
class blogaboutController extends Controller
{
    ...
    public function index(){
       ...
       return view('admin.website.blogabout.all',compact('all'));
    }

    public function add(){
        return view('admin.website.blogabout.add');
    }
    public function edit($slug){
        $data=blogabout::where('status',1)->where('slug',$slug,)->firstOrFail();
        return view('admin.website.blogabout.edit',compact('data'));
    }
    public function view($slug){
        $data=blogabout::where('status',1)->where('slug',$slug,)->firstOrFail();
        return view('admin.website.blogabout.view',compact('data'));
    }
